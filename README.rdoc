...
Task: This week is about learning how ot benchmark your code and explore how ruby versions speeds differ.

  1)  git clone git@github.com:Tukaiz/tukaiz_dojo_2.git
...
Things to think about/discuss:
  Notice that everyone had pretty much there "own" way to impliment the factorial. 
  
  Remember: This is a GOOD thing! Codeing should be more of an Art/Craft than a difinitive thing we do. 
            You can make the argument that yea speed is important and yes there is in many cases a "right" and "wrong" way to do something. 
  ...
  Take are little example and answer these questions. 
    ...
    Does changing the version of Ruby change the order of whos the fastes?
  ...
  For me I was very impressed with people who added checks for vaild Integers, people who used "real" recursion and how readable and easy to follow some of your code was!
